...
public class BlockDiamondChest extends BlockContainer
{
    ...
    protected static final AxisAlignedBB DIAMOND_CHEST_AABB = new AxisAlignedBB(0.0625D, 0.0D, 0.0625D, 0.9375D, 0.875D, 0.9375D);

    public BlockDiamondChest()
    {
        super(Material.IRON);
        ...
        UraBlocks.setBlockName(this, "diamond_chest");
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        if(!worldIn.isRemote)
        {
            playerIn.openGui(UraMod.instance, UraGui.GUI_DIAMOND_CHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
