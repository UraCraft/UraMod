...
import fr.uracraft.uramod.tileentity.chests.TileEntitySilverChest;
...
public class BlockSilverChest extends BlockContainer
{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    protected static final AxisAlignedBB SILVER_CHEST_AABB = new AxisAlignedBB(0.0625D, 0.0D, 0.0625D, 0.9375D, 0.875D, 0.9375D);

    public BlockSilverChest()
    {
        super(Material.IRON);
        ...
        UraBlocks.setBlockName(this, "silver_chest");
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        if(!worldIn.isRemote)
        {
            playerIn.openGui(UraMod.instance, UraGui.GUI_SILVER_CHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
