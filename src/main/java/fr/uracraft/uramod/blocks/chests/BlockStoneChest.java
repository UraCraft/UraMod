...
public class BlockStoneChest extends BlockContainer
{
    ...
    protected static final AxisAlignedBB STONE_CHEST_AABB = new AxisAlignedBB(0.0625D, 0.0D, 0.0625D, 0.9375D, 0.875D, 0.9375D);
    ...
    public BlockStoneChest()
    {
        ...
        UraBlocks.setBlockName(this, "stone_chest");
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        if(!worldIn.isRemote)
        {
            playerIn.openGui(UraMod.instance, UraGui.GUI_STONE_CHEST, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
    ...
    {
        TileEntityStoneChest tileentity = (TileEntityStoneChest)worldIn.getTileEntity(pos);
