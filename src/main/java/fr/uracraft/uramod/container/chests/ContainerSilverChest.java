...
public class ContainerSilverChest extends Container
{
    ...
    public ContainerSilverChest(InventoryPlayer playerInv, TileEntitySilverChest tileEntitySilverChest, EntityPlayer player)
    {
        this.chestInventory = tileEntitySilverChest;
        this.numRows = tileEntitySilverChest.getSizeInventory() / 9;
        tileEntitySilverChest.openInventory(player);
