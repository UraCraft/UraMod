...
import fr.uracraft.uramod.container.chests.ContainerIronChest;
...
public class GuiIronChest extends GuiContainer
{
    ...
    private final TileEntityIronChest te;
    private final int inventoryRows;

    public GuiIronChest(InventoryPlayer playerInventory, TileEntityIronChest chestInventory, EntityPlayer player)
    {
        super(new ContainerIronChest(playerInventory, chestInventory, player));
