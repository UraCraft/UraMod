...
public class GuiUraChest extends GuiContainer
{
    ...
    private final TileEntityUraChest te;
    private final int inventoryRows;

    public GuiUraChest(InventoryPlayer playerInventory, TileEntityUraChest chestInventory, EntityPlayer player)
    {
        super(new ContainerUraChest(playerInventory, chestInventory, player));
