...
public class PatchVanillaArmors {
    ...
    public static void armors(FMLPreInitializationEvent event) {
        ...
        ItemArmor.ArmorMaterial customDiam = EnumHelper.addArmorMaterial("CUSTOM_DIAMOND", "diamond", 5, new int[] {2, 5, 4, 1}, 10, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 0);
        ...
        //Iron Armor Reforged
        ItemArmor.ArmorMaterial customIron = EnumHelper.addArmorMaterial("CUSTOM_IRON", "iron", 5, new int[] {2, 5, 3, 1}, 9, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 0);
        ...
        //Gold Armor Reforged
        ItemArmor.ArmorMaterial customGold = EnumHelper.addArmorMaterial("CUSTOM_GOLD", "gold", 5, new int[] {1, 2, 1, 1}, 25, SoundEvents.ITEM_ARMOR_EQUIP_GOLD, 0);
        ...
        ItemArmor.ArmorMaterial customChain = EnumHelper.addArmorMaterial("CUSTOM_CHAIN", "chainmail", 5, new int[] {1, 2, 2, 1}, 12, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, 0);
